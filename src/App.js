  ...
  return (
    <div className="app">
      ...
      <main class="portfolio">
        <div class="container">
          ...
          <div id="portfolioInner" class="portfolio-inner">
            ...
            >
              ...
              <p class="card-name">
                <span>
                  Логистика грузов (возможно, не работает в вашей стране)
                </span>
              </p>
            </a>
            <a
            ...
            >
              ...
              <p class="card-name">
                <span>
                  Сompany accounting (in progress, hubadmin@gmail.com,
                  Superpasswordhub2)
                </span>
              </p>
            </a>
        ...
        <div class="container">
          <h3>Проекты для внутреннего пользования компании</h3>
          <div id="portfolioInner" class="portfolio-inner">
        ...
        <div class="container">
          <h3>Недоступные или закрытые проекты</h3>
          <div id="portfolioInner" class="portfolio-inner">
            <div class="card-item" data-work-id="605b843eeef00014b0ea18f2">
              <div class="categories-wrapper">
                <span class="tech-name css" data-teck-name="html">
